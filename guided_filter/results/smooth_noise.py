...
def GuidedFilterImg(C_Input_32F, C_Guidnace_32F, sigma=10):#img should be RGB,32float and 0-1 value range. sigma=5 or 10.
    guided_filter = FastGuidedFilter(C_Guidnace_32F, radius=sigma, epsilon=0.02)
...
if __name__ == '__main__':
    ...
    input_imagefile = './inputs/11_w_log.bmp'
    guidance_imgfile = './guidance/11_log.bmp'
    GuidedFilter(input_imagefile, guidance_imgfile)
